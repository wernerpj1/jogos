...
namespace Jogos.Views
{
    public class JogoViewInput
    {
        ...
        [StringLength(2500, MinimumLength = 3, ErrorMessage ="O nome tem que ter de 3 à 250 caracteres")]
        ...
        [StringLength(250, MinimumLength = 3, ErrorMessage ="A descrição tem que ter de 3 à 2500 caracteres")]
